...
export default function AddOns() {
  ...
  return (
    <div>
          ...
          >
            <div className="flex items-center gap-x-5">
              ...
              <div className="flex flex-col">
                <span className="text-blue-950 font-medium">{addon.title}</span>
      ...
      <div className="p-2 absolute bottom-0 right-0 w-full flex items-center justify-between bg-white">
        <Link to={"/plan"}>
          <GoBack />
        </Link>
        <NextStep />
