...
export function ChartBarMultiple() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl font-semibold text-dark-blue-shade">Total Revenue</CardTitle>
      ...
      <CardContent>
        <ChartContainer className="h-85 w-full" config={chartConfig}>
          <BarChart accessibilityLayer data={chartData}>
            ...
            />
            <Bar dataKey="desktop" fill="var(--color-barChartStashed-blue)" radius={4} />
            <Bar dataKey="mobile" fill="var(--color-barChartStashed-green)" radius={4} />
          </BarChart>
        </ChartContainer>
      </CardContent>
